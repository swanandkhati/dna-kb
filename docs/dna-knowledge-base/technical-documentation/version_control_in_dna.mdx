...
<a href="/img/dna/technical-documentation-img/git-workflow strategy-dna-snowflake.png" target="_blank">
<img src="/img/dna/technical-documentation-img/git-workflow strategy-dna-snowflake.png" alt="DNA Git Strategy"></img></a>
